...
const posts = [
  {
    title: "Ojay Motors launches certified hybrid collection",
  ...
  return (
    <section className="page-section">
      <div className="container">
        <SectionHeading
          eyebrow="Insights"
          title="News, guides, and marketplace updates"
          description="This page now feels more like a product content hub with stronger structure, cleaner filters, and better story cards."
        />
        ...
        <div className="news-grid">
          {filtered.map((post) => (
            ...
            >
              <span className="news-tag">{post.feature}</span>
              <h3>{post.title}</h3>
              <p>{post.summary}</p>
